	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 3px hsl(var(--pink-light) / 0.15), 0 0 6px hsl(var(--pink-light) / 0.05)' },
					'50%': { boxShadow: '0 0 8px hsl(var(--pink-light) / 0.3), 0 0 15px hsl(var(--pink-light) / 0.1)' }
				},
				'fade-in-slide-up': {
